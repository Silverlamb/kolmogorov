...
![](compression_regression_degree_3.png)![](compression_regression_degree_15.png)![](compression_regression_degree_5.png)
...
So lets try a lower envelope approximation (rolling minimum). Here is what we get.
![](compression_envelope.png)
This method is providing real shape our data points. Maybe we can smooth this out? Lets try applying Savitzky-Golay.
![](compression_smoothed_envelope.png)
...
- Update markdown names for images
### Thoughts
